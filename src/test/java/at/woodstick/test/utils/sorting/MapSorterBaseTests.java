...
/**
 * Base Unit tests for {@link MapSorter} interface implementations
 */
public abstract class MapSorterBaseTests {
	
	/**
	 * Instance of the logger
	 */
	private static final Logger LOGGER = LogManager.getLogger(MapSorterBaseTests.class);
	...
	/**
	 * Should create the SUT instance of the {@link MapSorter} interface implementation
	 * 
	 * @param sourceMap Map that will be sorted
	 * @return SUT {@link MapSorter} interface implementation
	 * 
	 * @param <K> type of the map keys
	 * @param <V> type of the mapped values
	 */
	protected abstract <K, V> MapSorter<K, V> createSUT(Map<K, V> sourceMap);
	
	/**
	 * Hook to provide logger
	...
	public void shouldSortMapByIntegerValuesInNaturalOrder() {
		...
		MapSorter<String, Integer> collectionSorter = createSUT(sourceMap);
		Map<String, Integer> resultMap = collectionSorter.sort();

		// Verify
		
		getLogger().info(sourceMap.values());
		getLogger().info(resultMap.values());
		getLogger().info(expectedMap.values());
	...
	public void shouldSortMapByStringValuesInNaturalOrder() {
		...
		MapSorter<String, String> collectionSorter = createSUT(sourceMap);
	...
	public void shouldSortMapByClassValuesPropertyInNaturalOrder() {
		...
		MapSorter<String, SortableTestClass> collectionSorter = createSUT(sourceMap);
